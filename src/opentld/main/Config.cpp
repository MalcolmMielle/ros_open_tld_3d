...
int Config::configure(Main *main)
{
    ...
    main->modelExportFile = m_settings.m_modelExportFile;
    main->loadModel = m_settings.m_loadModel;
    main->modelPath = (m_settings.m_modelPath.empty()) ? "" : m_settings.m_modelPath;
    ...
    IDetectorCascade *detectorCascade = main->tld->detectorCascade;
